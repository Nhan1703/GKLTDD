  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final illustrationHeight = maxH.isFinite && maxH > 0 ? (maxH * 0.52).clamp(120.0, 260.0) : 260.0;
        return SingleChildScrollView(
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                SizedBox(height: maxH.isFinite && maxH < 320 ? 8 : 16),
                SizedBox(
                  ...
                  child: Stack(
                    ...
                    children: [
                      CustomPaint(
                        ...
                        size: Size(constraints.maxWidth, illustrationHeight),
                      ),
                      Positioned(
                      ...
                      Positioned(
                        bottom: illustrationHeight * 0.07,
                        left: 70,
                        child: Image.asset('assets/images/woman.png', height: illustrationHeight * 0.65),
                      ),
                      Positioned(
                        bottom: illustrationHeight * 0.04,
                        left: 160,
                        child: Image.asset('assets/images/man.png', height: illustrationHeight * 0.67),
                      ),
                    ],
                  ),
                ),
...
class _OnboardingPage2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        final maxH = constraints.maxHeight;
        final illustrationHeight = maxH.isFinite && maxH > 0 ? (maxH * 0.52).clamp(130.0, 280.0) : 280.0;
        return SingleChildScrollView(
          physics: const ClampingScrollPhysics(),
          child: Padding(
            padding: const EdgeInsets.only(bottom: 12),
            child: Column(
              ...
              children: [
                SizedBox(height: maxH.isFinite && maxH < 340 ? 4 : 8),
                SizedBox(
                  height: illustrationHeight,
                  child: Stack(
                    alignment: Alignment.center,
                    children: [
                      ...
                      Positioned(
                        bottom: illustrationHeight * 0.04,
                        left: 120,
                        child: Image.asset('assets/images/woman_back.png', height: illustrationHeight * 0.68),
                      ),
                    ],
                  ),
                ),
      ...
      builder: (context, constraints) {
        ...
        return SingleChildScrollView(
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                SizedBox(height: maxH.isFinite && maxH < 320 ? 4 : 8),
                SizedBox(
                  height: illustrationHeight,
                  width: double.infinity,
                  child: Image.asset(
